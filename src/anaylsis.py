...
from db.tables import bookings_table, booking_status_table, cancellations_table, customers_table, incomplete_rides_table, locations_table, vehicle_types_table
